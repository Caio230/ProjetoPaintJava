...
public class JanelaPaint extends javax.swing.JFrame {
   ...
   // protected boolean disp;
    ...
    private ArrayList<Quadrado1> auxq = new ArrayList();
    private ArrayList<Elipse> auxe = new ArrayList();
    ...
    private void initComponents() {
        ...
        BotaoQuadrado.setBackground(new java.awt.Color(0, 0, 255));
        ...
        BotaoElipse.setBackground(new java.awt.Color(0, 0, 255));
        ...
        painel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Quadro De Desenho", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        LimparTela.setBackground(new java.awt.Color(0, 0, 255));
        ...
        QuadradoColorido.setBackground(new java.awt.Color(0, 0, 255));
        ...
        ElipseColorida.setBackground(new java.awt.Color(0, 0, 255));
        ...
        RmvFigura.setBackground(new java.awt.Color(0, 0, 255));
    ...
    if(mouseExit == true ) jm.setVisible(true);    
            ...
            if((xf - x) > 0 && (yf - y) > 0) {
                try {
                    ...
                    e.add(elipse);
                    model.addElement("ElipseColorida " + contadorEC);
                jList1.setModel(model);
                } catch (ValoresInvalidosException ex) {
                    JOptionPane.showMessageDialog(null, "Valor Invalido!!");
                }
...
//Ação do botao Imprimir
    private void ImprimeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ImprimeActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Lembre-se de limpar tudo antes de criar um novo arquivo com novas figuras");
...
//Remover as figuras adicionadas
    ...
    String s2 = model.get(indiceJList);
        if(botaoRemoveFigura == true){
            ...
            }else if(s2.startsWith("ElipseColori")){
